...
class BooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'info_book_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'info_book_id_fk' => ['type' => 'foreign', 'columns' => ['info_book_id'], 'references' => ['info_books', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
    ];
