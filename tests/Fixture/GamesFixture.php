...
class GamesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'info_game_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'autoIncrement' => null],
        ...
        'state' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => 'good', 'precision' => null, 'comment' => null, 'collate' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'user_id_fk' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'info_game_id_fk' => ['type' => 'foreign', 'columns' => ['info_game_id'], 'references' => ['info_games', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
    ];
